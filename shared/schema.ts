...
export const tables = pgTable("tables", {
  ...
  // Enhanced table mapping fields
  geometry: jsonb("geometry").$type<any>().default({}).notNull(),
  svg_path: text("svg_path"),
  centroid_x: decimal("centroid_x", { precision: 10, scale: 2 }),
  centroid_y: decimal("centroid_y", { precision: 10, scale: 2 }),
  rotation: decimal("rotation", { precision: 5, scale: 2 }),
  section: varchar("section"),
  source_map_hash: varchar("source_map_hash"),
